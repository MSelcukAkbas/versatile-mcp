...
def register_diagnostic_tools(mcp: FastMCP, diag_svc, audit_logs_path, memory_path, PROJECT_ROOT, SERVER_HOME):
    ...
    async def system_info() -> str:
        ...
        Provides a snapshot of the execution environment including OS, CPU, RAM, and storage.
        
        Use this tool to:
        - Understand the host platform before running OS-specific commands.
        - Monitor resource usage (RAM/Disk) of the server.
        - Verify active project roots and working directories.
        """
        try:
