...
def register_file_tools(mcp: FastMCP, file_svc):
    @mcp.tool()
    ...
    @mcp.tool()
    def list_directory_with_sizes(directory: str = ".") -> str:
        """List directory contents with file sizes."""
        try: return json.dumps(file_svc.list_directory_with_sizes(directory), indent=2)
        except Exception as e: return str(e)

    @mcp.tool()
    def directory_tree(directory: str = ".", max_depth: int = 3) -> str:
    ...
    @mcp.tool()
    def search_content(query: str, directory: str = ".") -> str:
        """
